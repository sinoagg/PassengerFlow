...
=====================================================================
*/
//static void ViBe::saveXYZ(const char* filename, const Mat& mat)
    void ViBe::saveXYZ(const  char* filename,const Mat& mat)
{
 ...
 void ViBe::disp2Depth(cv::Mat dispMap, cv::Mat &depthMap)
 {
...
Mat ViBe::getHistograph(const Mat grayImage)  
 {  
     int channels[]={0};  
